...
| Release | Signed archive, privacy disclosures, versioning, visual assets, TestFlight | Release evidence | Current unsigned generic-device archive and release checklist passed locally on 2026-06-15, including AppIcon packaging, local privacy-review docs, locally rendered website privacy/support pages, and a local App Store listing draft. Signed archive/export, App Store Connect visual/privacy entry, public URL deployment, final screenshots, and TestFlight not started |
