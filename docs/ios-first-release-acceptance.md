...
| Release | Signed archive, privacy disclosures, versioning, visual assets, TestFlight | Release evidence | Unsigned generic-device archive and release checklist passed locally, including AppIcon packaging. Signed archive/export, App Store Connect visual/privacy review, and TestFlight not started |
