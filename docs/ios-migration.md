...
- `AppDependencyFactory.makeKmpWithRealFirstReleaseCore()` is the broadest explicit development assembly: real CAS auth, JWAPP schedule/exams/textbooks/grades and school-wide course search, ncard campus card, public notices, empty-room CDN, library seats, and coupons. It is still not the default path.
