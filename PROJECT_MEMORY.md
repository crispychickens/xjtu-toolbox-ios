...
| R1 | Run the hardened iOS validation workflow remotely and record a passing GitHub result for current shared check, 27 unit/contract tests, 5 UI smoke tests, and unsigned-archive gates. | M | high |
