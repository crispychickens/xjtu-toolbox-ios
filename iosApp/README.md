...
- `AppDependencyFactory.makeKmpWithRealFirstReleaseCore()` is the broadest explicit development assembly for real CAS auth, JWAPP schedule/grades and school-wide course search, ncard campus card, public notices, empty rooms, library seats, and coupons. It is not the default startup path.
